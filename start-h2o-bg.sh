...
#nohup java -Xmx${xmxMb}m -jar h2o.jar -name H2ODemo -flatfile flatfile.txt -port 54321 -beta -ice_root ${d}/ice_root ${hdfs_config_option} ${hdfs_config_value} ${hdfs_option} ${hdfs_option_value} ${hdfs_version} ${aws_credentials} 1> h2o.out 2> h2o.err &
nohup java -Xmx1g -jar h2o.jar -flatfile flatfile.txt -port 54321 ${aws_credentials} 1> h2o.out 2> h2o.err &
